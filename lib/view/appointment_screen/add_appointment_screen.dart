                            ...
                            builder: (BuildContext context) {
                              return CustomShowDialog(title: 'Delete Appointment', subTitle: 'Please confirm if you want to delete this \n appointment', icon: const Icon(Icons.delete,color: Colors.red,), onTap: (){
                                box.deleteAt(index);
                                            ...
                                            // CustomSnackbar(text: 'Record deleted', backgroundColor: Colors.red).snackBar(context);
                                            // ScaffoldMessenger.of(context).showSnackBar(
                                            //   SnackBar(content: CustomSnackbar(text: 'Record deleted', backgroundColor: Colors.red))
...
//       ),
//       body: ValueListenableBuilder(
//         valueListenable: Hive.box<DoctorAppoitmentDb>('doctorAppointmentBox').listenable(),
//         builder: (context, Box<DoctorAppoitmentDb> box, child) {
//           if (box.isEmpty) {
//             return const Center(child: Text("You don't have any appointments yet"));
//           } else {
//             return ListView.builder(
//               itemCount: box.length,
//               itemBuilder: (context, index) {
//                 final doctorAppointment = box.getAt(index) as DoctorAppoitmentDb;
//                 return Padding(
...
//                         subTitle: 'Please confirm if you want to delete this appointment.',
...
//                           crossAxisAlignment: CrossAxisAlignment.start,
//                           children: [
//                             Text('${doctorAppointment.date}, ${doctorAppointment.time}', style: const TextStyle(fontSize: 16)),
//                             const SizedBox(height: 8),
//                             Text(doctorAppointment.doctorName, style: const TextStyle(color: Colors.blueGrey)),
//                             Text(doctorAppointment.address.toString(), style: const TextStyle(color: Colors.blueGrey)),
//                           ],
//                         ),
//                       ),
//                     ),
